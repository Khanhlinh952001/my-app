...
const TestingLayout = ({ children, scoreTrackingProps, selectedSet, answeredQuestions}) => {
  ...
  return (
    <div className='bg-slate-200 relative'>
      ...
      <div className="flex">
      {scoreTrackingProps.showTracking && (
          <div className="lg:md:w-2/12 sm:w- bg-gray-100 mt-36 mr-1 lg:block md:block sm:hidden hiddenC">
       ...
       <div className={`w-10/12 ml-1 mt-8 mr-2 h-screen overflow-y-auto layoutSM ${scoreTrackingProps.showTracking ? 'sm:w-full sm:mx-1' : ''}`}>
          {children}
        </div>
      </div>
    </div>
